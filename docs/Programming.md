...
* Program the FTDI .xml
* Program the PIC18F87J11 with the .hex
* Program the SPI chip
...
Use the [updater tool](https://github.com/Pheeeeenom/360-Lizard-RE/raw/refs/heads/main/sw/LizardFwUpdater_work_deob.exe) and click on "2 - Flash Update" then click connect and once it connects click Flash Device and select the [.bin](https://github.com/Pheeeeenom/360-Lizard-RE/raw/refs/heads/main/sw/SPI/spi_v1.34_last_official_fw.bin) and just wait.